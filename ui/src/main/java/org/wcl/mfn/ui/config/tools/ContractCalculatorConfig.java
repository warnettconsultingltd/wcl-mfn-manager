package org.wcl.mfn.ui.config.tools;
...
public class ContractCalculatorConfig {
    ...
    public String suggestedContracts() {
    ...
    public String escalatorValue() {
        return escalatorValue;
    }

    public int escalatorDefault() {
        return escalatorDefault;
    }

    public int escalatorMax() {
        return escalatorMax;
    }

    public int escalatorStep() {
    ...
    public String suggestedContractsTable() {
        return suggestedContractsTable;
    }

    public String suggestedContractsMainHeader() {
        return suggestedContractsMainHeader;
    }

    public String suggestedContractsSubHeaderYears() {
        return suggestedContractsSubHeaderYears;
    }

    public String suggestedContractsSubHeaderSalary() {
        return suggestedContractsSubHeaderSalary;
    }

    public String suggestedContractsSubHeaderRemuneration() {
        return suggestedContractsSubHeaderRemuneration;
    }

    public String suggestedContractsSubHeaderContractYear() {
        return suggestedContractsSubHeaderContractYear;
    }

    public String suggestedContractsSubHeaderContractYearSalary() {
        return suggestedContractsSubHeaderContractYearSalary;
    }

    public String suggestedContractsSubHeaderContractYearlyBonus() {
        return suggestedContractsSubHeaderContractYearlyBonus;
    }

    public String suggestedContractsSubHeaderContractYearlyTotal() {
        return suggestedContractsSubHeaderContractYearlyTotal;
    }

    public String suggestedContractsContractYears() {
        return suggestedContractsContractYears;
    }

    public String suggestedContractsTotalSalary() {
        return suggestedContractsTotalSalary;
    }

    public String suggestedContractsTotalRemuneration() {
        return suggestedContractsTotalRemuneration;
    }

    public String suggestedContractsCurrentYear() {
        return suggestedContractsCurrentYear;
    }

    public String suggestedContractsYearSalary() {
        return suggestedContractsYearSalary;
    }

    public String suggestedContractsBonusPerYear() {
        return suggestedContractsBonusPerYear;
    }

    public String suggestedContractsTotalPerYear() {
